...
#define PIPE_CHAR   '|'
#define PIPE_STRING "|"
#define REDIR_CHAR_OUT  '>'
#define REDIR_CHAR_IN   '<'
#define REDIR_STRING_OUT ">"
#define REDIR_STRING_IN  "<"
#define REDIR_STRING_OUT_APPEND ">>"
...
#define CMD_EXIT_MESSAGE    "exiting...\n"
#define CMD_RC_MESSAGE      "%d\n"
